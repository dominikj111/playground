...
use bevy::{
    ...
    prelude::*,
    window::{WindowLevel, PresentMode, CompositeAlphaMode},
};
    ...
    App::new()
        ...
        .add_plugins(DefaultPlugins.set(WindowPlugin {
            primary_window: Some(Window {
                ...
                decorations: false,  // Disable the window frame
                window_level: WindowLevel::AlwaysOnTop, // Keep the window on top
                present_mode: PresentMode::AutoVsync, // Add vsync
                composite_alpha_mode: CompositeAlphaMode::PostMultiplied, // Enable alpha compositing
                ..default()
            }),
            ..default()
        }).set(ImagePlugin::default_nearest())) // Set nearest neighbor sampling for pixel-perfect sprites
...
fn setup(
    ...
    // Spawn a camera with proper transparency settings
    commands.spawn((
        Camera2d,
        Camera {
